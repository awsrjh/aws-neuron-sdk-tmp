...
prior optimizations are outlined in the neuron-cc `release
notes <./neuron-cc.md>`__.
...
neuron-monitor
`here <../docs/neuron-tools/neuron-monitor-user-guide.md>`__.
...
found `here <../docs/neuron-container-tools/k8s-neuron-scheduler.md>`__.
Check the `Neuron K8 release notes <./neuron-k8.md>`__ for details
...
available `here <../src/examples/tensorflow/openpose_demo/>`__.
...
manual partition is needed. More details `here <torch-neuron.md>`__. The
...
execute NEFFs compiled from this release forward. Please see `Neuron
Runtime Release Notes <./neuron-runtime.md#neff-support-table>`__ for
compatibility.

Stay up to date on future improvements and new features by following the
`Neuron SDK
Roadmap <https://github.com/aws/aws-neuron-sdk/projects/2>`__.
...
peak thoughput of 360 seq/second on inf1.xlarge (more details
`here <./../src/examples/tensorflow/bert_demo/README.md>`__).
...
to stay up to date follow this repository and our `Neuron
roadmap <https://github.com/aws/aws-neuron-sdk/projects/2>`__.
...
SSD inference demo is available
`here <../src/examples/tensorflow/ssd300_demo>`__
...
additions to the GitHub with `new tech notes <../docs/technotes>`__
...
This structure is shown below, with each also linking to the release
notes for that package itself as well as showing the consitutuent
included packages:

`DLAMI Release Notes <./dlami-release-notes.md>`__
--------------------------------------------------

-  .. rubric:: `Conda TensorFlow Release
      Notes <./conda/conda-tensorflow-neuron.md>`__
      :name: conda-tensorflow-release-notes

   -  .. rubric:: `TensorFlow-Neuron Release
         Notes <./tensorflow-neuron.md>`__
         :name: tensorflow-neuron-release-notes

   -  .. rubric:: `Neuron-CC Release Notes <./neuron-cc.md>`__
         :name: neuron-cc-release-notes

   -  .. rubric:: `TensorBoard-Neuron Release
         Notes <./tensorboard-neuron.md>`__
         :name: tensorboard-neuron-release-notes

-  .. rubric:: `Conda MXNet Release
      Notes <./conda/conda-mxnet-neuron.md>`__
      :name: conda-mxnet-release-notes

   -  .. rubric:: `MXNet-Neuron Release Notes <./mxnet-neuron.md>`__
         :name: mxnet-neuron-release-notes

   -  .. rubric:: `Neuron-CC Release Notes <./neuron-cc.md>`__
         :name: neuron-cc-release-notes-1

-  .. rubric:: `Conda Torch Release
      Notes <./conda/conda-torch-neuron.md>`__
      :name: conda-torch-release-notes

   -  .. rubric:: `Torch-Neuron Release Notes <./torch-neuron.md>`__
         :name: torch-neuron-release-notes

   -  .. rubric:: `Neuron-CC Release Notes <./neuron-cc.md>`__
         :name: neuron-cc-release-notes-2

-  .. rubric:: `TensorFlow-Model-Server-Neuron Release
      Notes <./tensorflow-modelserver-neuron.md>`__
      :name: tensorflow-model-server-neuron-release-notes

-  .. rubric:: `Neuron-Runtime Release Notes <./neuron-runtime.md>`__
      :name: neuron-runtime-release-notes

-  .. rubric:: `Neuron-Tools Release Notes <./neuron-tools.md>`__
      :name: neuron-tools-release-notes

.. _neuron-cc-release-notes-3:

`Neuron-CC Release Notes <./neuron-cc.md>`__
--------------------------------------------

.. _neuron-runtime-release-notes-1:

`Neuron-Runtime Release Notes <./neuron-runtime.md>`__
------------------------------------------------------

.. _neuron-tools-release-notes-1:

`Neuron-Tools Release Notes <./neuron-tools.md>`__
--------------------------------------------------

.. _mxnet-neuron-release-notes-1:

`MXNet-Neuron Release Notes <./mxnet-neuron.md>`__
--------------------------------------------------

.. _tensorflow-neuron-release-notes-1:

`TensorFlow-Neuron Release Notes <./tensorflow-neuron.md>`__
------------------------------------------------------------

.. _tensorboard-neuron-release-notes-1:

`Tensorboard-Neuron Release Notes <./tensorboard-neuron.md>`__
--------------------------------------------------------------

.. _torch-neuron-release-notes-1:

`Torch-Neuron Release Notes <./torch-neuron.md>`__
--------------------------------------------------
