...
See the `LICENSE-DOCUMENTATION <./LICENSE-DOCUMENTATION>`__,
`LICENSE-SAMPLECODE <./LICENSE-SAMPLECODE>`__ and
`LICENSE-SUMMARY-DOCS-SAMPLES <./LICENSE-SUMMARY-DOCS-SAMPLES>`__ files
